    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tamano_producto', models.CharField(blank=True, choices=[('No definido', 'No definido'), ('S', 'S'), ('M', 'M'), ('L', 'L'), ('XL', 'XL')], max_length=50, null=True)),
                ('observacion_producto', models.TextField(blank=True, null=True)),
                ('precio_unitario_producto', models.DecimalField(decimal_places=2, max_digits=20)),
